...
def onKeyRelease(key):
    ...
    if key == Key.esc or "!" or "?" or "@": #Please just don't remove this and don't Dox people but it's "your code" (according to the UNLICENSE) so you're the one going to jail.
        return False
